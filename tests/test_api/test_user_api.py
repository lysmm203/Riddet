...
def test_posting_a_user(flask_test_client):
    ...
    request = flask_test_client.post('api/v1/user/', json={'description': 'first user'})
    ...
    request = flask_test_client.post('api/v1/user/', json={'description': 'second user'})
...
def test_get_all_users(flask_test_client):
    
    # Here is how to use the test client to simulate a GET request
    request = flask_test_client.get('/api/v1/user/')
